                            ...
                            <tbody>
                                @foreach ($carburants as $key => $carburant)
                                    <tr>
                                        ...
                                        <td>{{ $carburant->nom_fournisseur }}</td>
...
<div class="modal right fade" id="editcarburant{{ $carburant->id }}" data-bs-backdrop="static"
                ...
                <form action="{{ route('carburants.update', $carburant->id) }}" method="POST">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <select name="type_carburant" id="type_carburant" class="form-control" tabindex="-1"
                                class="@error('type_carburant') is-invalid @enderror">
                                <option value="" disabled="true" selected="true">{{ $carburant->type_carburant }}
                                </option>
                                <option>Essance</option>
                                <option>Gasoil</option>
                                @error('type_carburant')
                        ...
                        <div class="form-group col-md-4">
                            <label for="input-28">Fournisseur</label>
                            <select name="fournisseur_id" id="" class="form-control" tabindex="-1"
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="number" name="distance" id="distance" required="required" class="form-control "
                                class="@error('distance') is-invalid @enderror" placeholder=""
                                value="{{ $carburant->distance }}">
                            @error('distance')
                                <button class="btn-danger">{{ $message }}</button>
                            @enderror
                        </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            <label for="input-28">Date d'emregistrement</label>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('carburants.destroy', $carburant->id) }}" method="POST">
                    @csrf
                    @method('delete')
                    <p>Tu es sur de vouloir supprimer {{ $carburant->quantite }}L d'(e)
